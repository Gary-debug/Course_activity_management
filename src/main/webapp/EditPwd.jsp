...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="login">
    ...
    <form action="SaveEditPwd.jsp?tid=<%=tid%>&tpwd=<%=tpwd%>" method="post">
    <div class="table-wrapper">
    <table class="fl-table" border="1" width="95%" align="center">
        <tr><td>密码</td><td><input type = "password" id="Pwd" name = "Pwd"  placeholder="请输入当前密码"/></td></tr>
        <tr><td>新密码</td><td><input type = "password" id="newpwd" name = "newpwd"  placeholder="请设置新密码"/></td></tr>
        <tr><td>确认密码</td><td><input type = "password" id="confirm" name = "confirm"  placeholder="请再次输入新密码"/></td></tr>
		<br>	
 		
<!--         <p style = "text-align:center"><input type="submit" name="commit" value="创建"></p> -->
         </table>
	</div>
<button style = "margin-left:570px" type="submit" onClick="return confirm('确定修改？')">修改</button>
    </form>
</div>
