...
wrs.close();
ResultSet rs=stmt.executeQuery("select distinct cno from tea_class where cno not in (select cno from class where sno='"+Sno+"')");
String op="";
...
<div class="layui-layout layui-layout-admin">
  ...
  <h1 style="text-align:center;padding:20px;line-height:150%">更多课程</h1>
					...
					while (rs.next()) {
					ResultSet r=stmt.executeQuery("select * from tea_class where cno='"+rs.getString("cno")+"'");
					r.next();
					...
					<td>
					<a
						href="classinfo.jsp?cno=<%=rs.getString("cno")%>">
							...
							<div class="card" style="width: 250px; height: 200px">
								...
								<div class="card-body" style="margin:1%">
									<h2  style="line-height:1.5em">
										<strong><%=r.getString("cname")%></strong></h2>		
