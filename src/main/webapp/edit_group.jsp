...
//返回列表
%>
    <form action="edit_group_save.jsp" method="post">
        <div class="table-wrapper">
    <table class="fl-table" border="1" width="95%" align="center">
    <tr>
    <td>活动号</td>
    <td><input type="number" name="ano" value=<%=request.getParameter("ano") %>> </td>
    </tr>
    <tr>
    <td>学号：</td>
    ...
    <td>调整分组为：</td>
    <td><select name="gno">
    <option selected>请选择小组号</option>
           <%
           javax.sql.rowset.WebRowSet rs=sqldb.DBtool.query("select distinct gno from grade where ano="+ano+" order by gno ");
            while(rs.next()){
