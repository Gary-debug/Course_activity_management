...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <div class="login">
    <h1 align = center>创建教学班级</h1>

    <form action="ClassAdd.jsp?tid=<%=tid%>&tpwd=<%=tpwd%>" method="post">
    <div class="table-wrapper">
    <table class="fl-table" border="1" width="95%" align="center">
        <tr><td>教学班级号</td><td><input type = "text" name = "cno" /></td></tr>
        <tr><td>课程名称</td><td><input type = "text" name = "cname" /></td></tr>
		<br>	
...
<button style = "margin-left:488px" type="submit">创建</button>
    </form>
</div>
