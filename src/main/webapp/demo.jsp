...
<div class="layui-layout layui-layout-admin">
  ...
  <div id="container">
    ...
    %>     
           ...
           <br>
            <a href="#" id="hpExport" onClick="return hpExport(this)">按活动导出excel</a>
                        <a href="#" id="hpExport" onClick="return hpExport2(this)">按学生导出excel</a>
            <br>
             <a href="#" id="csvExport" onClick="return csvExport(this)">按活动导出csv</a>
