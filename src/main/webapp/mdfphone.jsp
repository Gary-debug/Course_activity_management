...
<%}else if("1".equals(op)){%>
<script type="text/javascript">alert("联系方式不能为空！");</script><%
}else{}
%>
<body>
<div class="layui-layout layui-layout-admin">
  ...
  <form action="updatephone.jsp" method="post">
	<div style="height:30px;"></div>

	<div class="login-wrap">
		<div class="login-html">
		<h1 align =center style = "margin-top:15px;color:white">修改联系方式</h1>
		<br>
		<br>
			...
			<div class="login-form">
				<div class="sign-in-htm">
					<div class="group">
						<label for="oldphone" class="label">旧的联系方式</label>
						<input id="oldphone" type="text" name = "ophone" class="input" readonly value="<%=wrs.getString("message") %>"/>
					</div>
					
					<div class="group">
						<label for="newphone" class="label">新的联系方式</label>
						<input id="newphone" type="text" name = "nphone" class="input" />
					</div>
