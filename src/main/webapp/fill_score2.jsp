...
<li class="layui-nav-item layui-nav-itemed">
  ...
  <div class="layui-body">
	...
	ResultSet rs=stmt.executeQuery("select * from grade where ano="+ano+" ");
	%>
	<form>
 ...
 <td><%=rs.getString("gno") %>   </td>
 <td><%=rs.getString("v1") %> </td>
 <td><%=rs.getString("v2") %></td>
 <td><%=rs.getString("v3") %></td>
 <td><a href="editstu.jsp?sno=<%=rs.getString("sno") %>&sname=<%=rs.getString("sname")%>&gno=<%=rs.getString("gno")%>&w1=<%=w1%>&w2=<%=w2%>&w3=<%=w3%>" >修改成绩 </a></td>
