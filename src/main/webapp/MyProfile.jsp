...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
	...
	<table class="fl-table" border="1" width="95%" align="center">
		<tr><td>教师工号：</td>
		<td><input type = "text" name = "tid" value = "<%=tid%>" disabled/></td></tr>
		<tr><td>姓名：</td>
		<td><input type = "text" name = "tname" value = "<%=tname%>" disabled/></td></tr>
		<tr><td>个人简介：</td>
		<td><input type = "text" name = "intro" value = "<%=intro%>" disabled/></td></tr>
     </table>
     </div>
      </form>
    </div>
  ...
  <br>
			...
			<p style="text-align:center"><a href="EditTeacher.jsp?tid=<%=tid%>&tpwd=<%=tpwd%>" ><button type = "submit">修改信息</button></a></p>
