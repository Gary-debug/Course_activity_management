...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    <section class="container">
	  ...
	  <form action="AddStu.jsp?tid=<%=tid%>&tpwd=<%=tpwd%>&cno=<%=cno%>&cname=<%=cname%>" method="post">
	  <div class="table-wrapper">
    <table class="fl-table" border="1" width="95%" align="center">
        <tr><td>班级号</td><td><input type="text" name="cno"  value = <%=cno%> disabled/></td></tr>
        <tr><td>课程名称</td><td><input type="text" name="cname" value = <%=cname%> disabled/></td></tr>
        <tr><td>学号</td><td><input type="text" name="sno" /></td></tr>
        <tr><td>姓名</td><td><input type="text" name="sname"/></td></tr>
        <br>
<!--         <p style = "text-align:center"><input type="submit" name="commit" value="确认添加"></p> -->
        
        </table>
	</div>
	<button style = "margin-left:570px" type="submit">确认添加</button>
      </form>
    </div>
  </section>
<!--     <div style="padding: 15px;">欢迎登陆考试系统</div> -->
  </div>
