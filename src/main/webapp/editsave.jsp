    ...
    <div class="layui-side-scroll">
      ...
      <li class="layui-nav-item layui-nav-itemed">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            <dd><a href="control_state.jsp">管理活动状态</a></dd>
          </dl>
          </dl>
          <dl class="layui-nav-child">
            <dd><a href="fill_score.jsp">填写活动成绩</a></dd>
          </dl>
        </li>
        <li class="layui-nav-item">
...
String sql="update grade set w1 = "+w1+",w2="+w2+",w3="+w3+",v1="+v1+",v2="+v2+",v3="+v3+" where sno='"+sno+"'";
